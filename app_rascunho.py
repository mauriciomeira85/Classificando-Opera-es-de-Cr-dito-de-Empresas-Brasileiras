...
if tipo_cliente == "PJ - Pessoa Jurídica":
    ...
    if submitted:
        ...
        input_data = {
            ...
            "eh_fim_de_ano": int(eh_fim_de_ano),
            ...
            "origem": origem,
            "indexador": indexador,
            "numero_operacoes_int": int(0),
            "a_vencer_ate_90_dias": float(0.0),
            "a_vencer_de_91_ate_360_dias": float(0.0),
            "a_vencer_acima_de_5400_dias": float(0.0),
            "vencido_acima_de_15_dias": float(0.0),
            "carteira_ativa": float(0.0),
            "ativo_problematico": float(0.0)
        }
